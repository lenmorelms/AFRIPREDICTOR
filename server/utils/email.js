...
const sendVerificationEmail = async (email, verificationToken, source) => {
    ...
    const mailOptions = {
        ...
        html: source === "register" ? `<p>Please click <a href="http://localhost:3000/verify/${verificationToken}">here</a> to verify your account.</p>` : `<p>Please click <a href="http://localhost:3000/reset-password/${verificationToken}">here</a> to reset your password.</p>`
    };
